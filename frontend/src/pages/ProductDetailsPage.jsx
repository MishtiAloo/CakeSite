...
function ProductDetailsPage() {
  ...
  const [inpValue, setInpValue] = useState(
    parsedProduct.productType === "cake"
      ? parsedProduct.minimumPound
      : parsedProduct.minimumOrder,
  );
    ...
    if (parsedProduct.productType === "cake") {
      setRelatedProducts(
        products.filter((product) => {
          return product.cakeType === parsedProduct.cakeType;
        }),
      );
    } else {
      setRelatedProducts(
        products.filter(
          (product) => product.snackType === parsedProduct.snackType,
        ),
      );
    }
  }, [products]);
    ...
    <div className="basic-page-container">
      <div className="basic-container" style={{ width: "95vw" }}>
        <div className="info-section">
          <div className="info-part">
            <div
              ...
              style={{ width: "80%", aspectRatio: "1/1", alignSelf: "center" }}
            >
              <img src={parsedProduct.productImage} alt="" />
            </div>
          </div>
          <div className="info-part">
            <div className="prod-type clickables">
            ...
            <div className="two-sided-info">
              <p style={{ fontSize: "2rem", color: "orangered" }}>
                {parsedProduct.productPrice}
                <span style={{ fontSize: "0.8rem" }}>
                  /{parsedProduct.productType === "cake" ? "pound" : "piece"}
                </span>
              </p>
              <p
                style={{
            ...
            <div className="two-sided-info">
              <div>
                ...
                >
                  minimum buy:{" "}
                  {parsedProduct.productType === "cake"
                    ? parsedProduct.minimumPound + " pounds"
                    : parsedProduct.minimumOrder + " pieces"}
                </p>
              </div>
              <PlusMinus
                value={inpValue}
        ...
        <div className="total-section">
          ...
          <button ref={myButton} onClick={handleAddToCart}>
            Add to cart
          </button>
        </div>
        ...
        <div className="descript-ingred-section">
          <div>
            ...
            >
              {" "}
              <span>
                <FaRegFileLines style={{ color: "orangered" }} />
              </span>{" "}
              Description
            </p>
            <p style={{ paddingLeft: "2rem" }}>
              {parsedProduct.productDescription}
            </p>
          </div>
          <div>
            <p
            ...
            >
              <span>
                <TbBowlChopsticks style={{ color: "orangered" }} />
              </span>
              Ingredients
            </p>
            <p style={{ paddingLeft: "2rem" }}>
              {parsedProduct.ingredients.join(", ")}
            </p>
          </div>
        </div>
      </div>

      <BasicProductSectionLinear
        sectionTitle="Related prods"
