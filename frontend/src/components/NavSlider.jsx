      ...
      <div className="slider">
        <div className="slider-content">
          ...
          <div className="slider-contact">
            <div
              className="basic-container clickables"
              style={{ width: "100%" }}
            >
              <h2>
                Call us: <span style={{ color: "black" }}>01xxxxxxx</span>
              </h2>
            </div>
          ...
          <div className="slider-quickLinks basic-container">
            ...
            <div style={{ paddingLeft: "2rem", margin: "1rem" }}>
              ...
              <p className="clickables">
                <FaInfoCircle /> <Link to="/about">About</Link>
              </p>
              <p className="clickables">
                <FaBoxOpen /> <Link to="/prodpage">Products</Link>
              </p>
              <p className="clickables">
                <FaTags /> <Link to="/offerpage">Offers</Link>
              </p>
              <p className="clickables">
                <FaPhone /> <Link to="/contact">Contact Us</Link>
              </p>
              <p className="clickables">
